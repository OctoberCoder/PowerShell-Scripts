<#
=============================================================================================
Name:           Generating Teams Reports
Description:    This script performs the action of spooling reports of all teams and channels in a tenant
Version:        1.0
...
Do {
 ...
 Write-Host  "    Please run this script in your test environment before running it in your production environment" -ForegroundColor Cyan
 Write-Host ""
